...
struct tcp_send_vars
{
  ...
  uint8_t ack_cnt:6;			/* number of acks to send. max 64 */
  ...
  uint8_t on_closeq_int:1, on_resetq_int:1, is_fin_sent:1, is_fin_ackd:1;
